...
public class CharsetsDisponibles {
    ...
    public static void main(String[] args) {
        ...
        for (Object charsetName : map.keySet()) {
            final Charset charset = Charset.forName((String) charsetName);
            System.out.printf("%s %s\n", charset.name(), charset.aliases().toString());
        }
        System.out.println("Número de charsets"+ map.keySet().size());
    }
}
/*
 * 
 * Si se conoce la codificación empleada en el archivo de entrada, es posible
 * leer correctamente casi cualquier formato de texto. Con este fin se utiliza
 * un InputStreamReader, a cuyo constructor se pasa como segundo argumento el
 * nombre del Charset empleado en la codificación del archivo de entrada.
 * 
 * El resultado de ejecutar este programa es (Lion 10.7.2)
 * 
 * Big5 [csBig5]
...
KOI8-U [koi8_u]
MacRoman [MacRoman, mac, csMacintosh, x-MacRoman, x-mac-roman]
...
x-MacArabic [x-mac-arabic, MacArabic]
x-MacCentralEurope [MacCentralEurRoman, x-mac-centraleurope, MacCentralEuropean, x-mac-centraleurroman, x-mac-ce, MacCentralEurope, x-mac-centraleuropean]
x-MacCroatian [MacCroatian, x-mac-croatian]
x-MacCyrillic [x-mac-cyrillic, MacCyrillic]
x-MacDingbat [x-mac-dingbats, MacDingbat, MacDingbats, x-mac-dingbat]
x-MacGreek [MacGreek, x-mac-greek]
x-MacHebrew [MacHebrew, x-mac-hebrew]
x-MacIceland [x-mac-iceland, MacIceland, MacIcelandic, x-mac-icelandic]
x-MacRomania [x-mac-romania, MacRomania, MacRomanian, x-mac-romanian]
x-MacSymbol [MacSymbol, x-mac-symbol]
x-MacThai [MacThai, x-mac-thai]
x-MacTurkish [MacTurkish, x-mac-turkish]
x-MacUkraine [x-mac-ukrainian, MacUkrainian, MacUkraine, x-mac-ukraine]
x-MS932_0213 []
